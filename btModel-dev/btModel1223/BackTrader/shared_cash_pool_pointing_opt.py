...
#计算板块指数 均线分数
    ...
    #     if MAX_M==M['沪锌'] and M['沪锌']==M['沪镍加权']:
    #         J2=2
    #     else:
    #         J2=0

    #     if MAX_M==M['沪铝加权'] and M['沪铝加权']==M['沪镍加权']:
    #         J3=3
    #     else:
    #         J3=0
    ...
    #                 margin_percent=margin_mult['margin']
    #                 mult=margin_mult['mult']
    #                 lots=int((fund*0.4)/(data.close[0]*margin_percent*mult))
    #                 self.buy(data=data,size=lots)
    #                 break
